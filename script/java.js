// theorie //
// javascript heeft functies zoals log, remove ect, en die roep je aan met "." dus '.log' bijvoorbeeld. functie voor add button//
...
addTaskButton.addEventListener('click', function () {
    // Als ik op add (knop) klik dan komt er een nieuwe taak in de lijst//

    //selecteer het input veld met getelement by id (in de dom)//
    ...
    // die taak is nu ook zichtbaar voor de gebruiker//
    ...
    //document.: je zegt "yo systeem, ik wil dat je iets voor me doet in dit document."
    // createElement: Dit is de geboorte van een element. 
    // De computer maakt een nieuw knopje aan in zijn geheugen. 
    // Dit knopje bestond hiervoor dus nog niet in je HTML.
    //('button'): Dit is het type dat je wilt maken. 
    // ik zeg: "Maak een element van het type 'button'." (ik had hier ook 'div' of 'p' kunnen invullen).
...
// dit selecteert die light button en zorgt er voor dat als je er op klikt dat hij het light thema toevoegt//    
lightBtn.addEventListener('click', () => {
    clearThemes(); //dit haalt het thema weg//
    body.classList.add('light-mode'); // dit voegt het light thema toe//
});
...
// tip: voor beginner s is dit een makkelijke manier om thema's te maken, maar je kunt zo ook korter schrijven wat handiger is voor grote projecten//
